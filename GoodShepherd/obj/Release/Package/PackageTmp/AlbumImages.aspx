<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeBehind="AlbumImages.aspx.cs" Inherits="AlbumImages" %>

<asp:Content runat="server" ID="cp" ContentPlaceHolderID="CPHHead">
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td>
                <asp:HyperLink runat="server" ID="lnkDownload" Style="float: left" CssClass="SiteText">تحميل البامفلت</asp:HyperLink></td>
        </tr>
        <tr>
            <td>
