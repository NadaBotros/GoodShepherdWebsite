<%@ Page Title="اجتماع الراعي الصالح | البوم الذكريات" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeBehind="Albums.aspx.cs" Inherits="Albums" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td>
                <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="LoadByDeleteState" TypeName="DAL.AlbumManagement">
                    <SelectParameters>
                    ...
                    <ItemTemplate>
                        <td id="itemPlaceholder" class="tdView" align="center" valign="top" runat="server">
                            <table style="margin: auto; text-align: center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td valign="top">
                                        <asp:HyperLink runat="server" CssClass="lnkImage" NavigateUrl='<%#"AlbumImages.aspx?id="+Eval("AlbumId") %>' ID="lnkImage" ImageUrl='<%#"images/S140_110/"+Eval("AlbumCover") %>'></asp:HyperLink>
                                    </td>
                                </tr>
                                <tr>
                                    <td><a href='<%#"AlbumImages.aspx?id="+Eval("AlbumId") %>'><%#Eval("AlbumName")+"<br/>"+Eval("date") %></a></td>
                                </tr>
                            </table>
                        </td>
                    </ItemTemplate>
