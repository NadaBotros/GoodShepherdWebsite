<%@ Page Title="" Language="C#" MasterPageFile="~/System/Backend/admin.Master" AutoEventWireup="true"
    CodeBehind="LibraryList.aspx.cs" EnableEventValidation="false" Inherits="System.Backend.LibraryList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHPageHeader" runat="server">
    <img src="../lib/icons/32/Dashboard.png" class="imgIcon" /><asp:Label runat="server"
        Text="اقسام المكتبات" CssClass="tdMainTitle" ID="lblPageMainTitle"></asp:Label>
</asp:Content>
    ...
    <table width="100%" cellpadding="2" cellspacing="2">
        <tr>
            <td class="tdHeader">
                ...
                <asp:Label runat="server" Text="قائمة اقسام المكتبات" CssClass="tdPageTitle" ID="lblPageSubTitle"></asp:Label>
                <asp:HyperLink runat="server" class="addnew" ID="btnAddNew" NavigateUrl="~/System/Backend/Libraries/LibraryManagement.aspx"
        ...
        <tr>
            <td>
                <asp:GridView ID="grdData" Width="100%" runat="server" CssClass="grd" DataSourceID="odsData"
                            ...
                            <ItemTemplate>
                                <div id="dvUp" style='width: 16px; height: 16px; float: left; display: <%# ShowArrow(Eval("RecOrder"), "U") %>'>
                                    <asp:ImageButton ID="ImgArrowUp" CssClass="btnArrUp" runat="server" CommandName="ArrowUp"
                                        CommandArgument='<%# Eval("LibraryItemId") %>' ImageUrl="~/App_Themes/Default/Images/Up.png"></asp:ImageButton>
                                </div>
                                <div id="dvDown" style='width: 16px; height: 16px; float: left; display: <%# ShowArrow(Eval("RecOrder"), "D") %>;'>
                                    <asp:ImageButton ID="ImgArrowDown" runat="server" CssClass="btnArrDown" CommandName="ArrowDown"
                                        CommandArgument='<%# Eval("LibraryItemId") %>' ImageUrl="~/App_Themes/Default/Images/Down.png"></asp:ImageButton>
                                </div>
                            </ItemTemplate>
                            <HeaderStyle Width="15%" />
                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="ItemTitle" HeaderText="اسم القسم" HeaderStyle-Width="70%" ItemStyle-Width="70%" />
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton ID="imgEdit" runat="server" CssClass="imgIcon3 tip_right_top" CommandName="Edititem"
                                    CommandArgument='<%# Eval("LibraryItemId") %>'
                                ...
                                <asp:ImageButton ID="imgRestore" runat="server" CssClass="imgIcon3 tip_right_top"
                                    ...
                                    CommandArgument='<%# Eval("LibraryItemId") %>' Visible='<%# DAL.GeneralMethods.DeleteRestorVisible(Eval("Active"),"true") %>'
                                ...
                                <asp:ImageButton ID="imgDelete" runat="server" CssClass="imgIcon3 tip_right_top" ImageUrl="../lib/img/Delete.png"
                                    CommandName="deleteitem" CommandArgument='<%# Eval("LibraryItemId") %>' OnClientClick="if(!confirm('Are you sure you want delete this?')) return false;"
                    ...
                    <EmptyDataTemplate>
                        <center>لا يوجد اقسام بداخل هذا القسم</center>
                    </EmptyDataTemplate>
                </asp:GridView>
                <asp:ObjectDataSource ID="odsData" runat="server" SelectMethod="LoadByDeleteState"
                    ...
                    <SelectParameters>
                        ...
                        <asp:QueryStringParameter DefaultValue="" Name="LibraryType" QueryStringField="type" Type="String" />
                    </SelectParameters>
