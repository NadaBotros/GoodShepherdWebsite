<%@ Page Title="" Language="C#" MasterPageFile="~/System/Backend/admin.Master" AutoEventWireup="true"
    CodeBehind="HobbiesManagement.aspx.cs" Inherits="System.Backend.manage.HobbiesManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHPageHeader" runat="server">
    ...
    <asp:Label runat="server" Text="هوايات المخدومين" CssClass="tdMainTitle" ID="lblPageMainTitle"> </asp:Label>
</asp:Content>
    ...
    <table width="100%" cellpadding="2" cellspacing="2">
        <tr>
            <td class="tdHeader">
                ...
                <asp:Label runat="server" Text="هوايات المخدومين" CssClass="tdPageTitle" ID="lblPageSubTitle"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <table cellpadding="2" cellspacing="2">
                    <tr>
                        <td>اسم الهواية <span class="reqstar">*</span>
                        </td>
                        <td>
