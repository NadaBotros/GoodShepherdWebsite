<%@ Page Title="" Language="C#" MasterPageFile="~/System/Backend/admin.Master" AutoEventWireup="true"
    CodeBehind="SpiritualTrainingManagement.aspx.cs" Inherits="System.Backend.manage.SpiritualTrainingManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHPageHeader" runat="server">
    ...
    <asp:Label runat="server" Text="التداريب الروحية" CssClass="tdMainTitle" ID="lblPageMainTitle"> </asp:Label>
</asp:Content>
    ...
    <table width="100%" cellpadding="2" cellspacing="2">
        <tr>
            <td class="tdHeader">
                ...
                <asp:Label runat="server" Text="ادارة التداريب الروحية" CssClass="tdPageTitle" ID="lblPageSubTitle"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <table cellpadding="2" cellspacing="2">
                    <tr>
                        <td>عنوان التدريب <span class="reqstar">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>نص التدريب <span class="reqstar">*</span>
                        </td>
                        <td>
                            <asp:TextBox runat="server" TextMode="MultiLine" style="height:220px;width:550px" SkinID="txtmult" ID="txtDesc"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                ValidationGroup="1" runat="server" ControlToValidate="txtDesc"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
            </td>
