<%@ Page Title="" Language="C#" MasterPageFile="~/System/Backend/admin.Master" AutoEventWireup="true"
    CodeBehind="SpeakersList.aspx.cs" EnableEventValidation="false" Inherits="System.Backend.SpeakersList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHPageHeader" runat="server">
    <img src="../lib/icons/32/Dashboard.png" class="imgIcon" /><asp:Label runat="server"
        Text="واعظين الاجتماع" CssClass="tdMainTitle" ID="lblPageMainTitle"></asp:Label>
</asp:Content>
    ...
    <table width="100%" cellpadding="2" cellspacing="2">
        <tr>
            <td class="tdHeader">
                ...
                <asp:Label runat="server" Text="قائمة واعظين الاجتماع" CssClass="tdPageTitle" ID="lblPageSubTitle"></asp:Label>
                <asp:HyperLink runat="server" class="addnew" ID="btnAddNew" NavigateUrl="~/System/Backend/Meeting/SpeakersManagement.aspx"
            ...
            <td>
                <asp:GridView ID="grdData" Width="100%" runat="server" CssClass="grd" DataSourceID="odsData"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ChurchName" HeaderText="كنيسة الواعظ" SortExpression="ChurchName">
                            <HeaderStyle Width="40%" />
                            <ItemStyle Width="40%" />
                        </asp:BoundField>                     
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="imgEdit" runat="server" CssClass="imgIcon3 tip_right_top" NavigateUrl='<%#"SpeakersManagement.aspx?id="+Eval("SpeakerId")%>'
                                ...
                                <asp:ImageButton ID="imgRestore" runat="server" CssClass="imgIcon3 tip_right_top"
                                    ...
                                    CommandArgument='<%# Eval("SpeakerId") %>' Visible='<%# DAL.GeneralMethods.DeleteRestorVisible(Eval("Active"),"true") %>'
                                ...
                                <asp:ImageButton ID="imgDelete" runat="server" CssClass="imgIcon3 tip_right_top" ImageUrl="../lib/img/Delete.png"
                                    CommandName="deleteitem" CommandArgument='<%# Eval("SpeakerId") %>' OnClientClick="if(!confirm('Are you sure you want delete this?')) return false;"
