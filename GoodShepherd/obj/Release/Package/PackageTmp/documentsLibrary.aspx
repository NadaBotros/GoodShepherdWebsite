<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInside.master" AutoEventWireup="true" CodeBehind="documentsLibrary.aspx.cs" Inherits="documentsLibrary" %>
                ...
                <asp:Repeater runat="server" ID="rptLibrary" OnItemDataBound="rptLibrary_ItemDataBound" DataSourceID="odsPath">
                    <ItemTemplate>
                        <asp:HyperLink Style="padding-top: 5px; padding-bottom: 5px; color: black; float: right; font-weight: bold; font-size: 13px; padding-left: 7px; padding-right: 7px; display: inline-block; text-decoration: none"
                            runat="server" ID="lblCatName" Text='<%# " » "+ Eval("ItemTitle") %>' NavigateUrl='<%# "documentsLibrary.aspx?id="+Eval("LibraryItemId") %>'></asp:HyperLink>
                        ...
                        <asp:GridView runat="server" ID="grdChildCats" DataSourceID="odsCatParent" CssClass="DropPanel"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HyperLink ID="lnkch" runat="server" Text='<%# Eval("ItemTitle") %>' NavigateUrl='<%# "documentsLibrary.aspx?id="+Eval("LibraryItemId") %>'
                            ...
                            <ItemTemplate>
                                <table style="float: left">
                                    <tr>
                                        <td valign="top">
                                            <div>
                                                <a target="_blank" href="https://twitter.com/share" class="twitter-share-button" data-url='<%#"http://shepherdmeeting.com/shepherdmeeting.com/documentsLibrary.aspx?id="+Eval("LibraryItemId") %>'></a>
                                            </div>
                                        </td>
                                        <td  valign="top">
                                            <div class="fb-share-button" data-href='<%#"http://shepherdmeeting.com/shepherdmeeting.com/documentsLibrary.aspx?id="+Eval("LibraryItemId") %>' data-type="button_count"></div>
                                        </td>
                                        <td  valign="top">
                                            <div style="height:20px">
                                                <script type="IN/Share" data-url='<%#"http://shepherdmeeting.com/shepherdmeeting.com/documentsLibrary.aspx?id="+Eval("LibraryItemId") %>'></script>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="عنوان الملف">
                            <ItemTemplate>
                                <table width="100%">
                                    <tr>
                                        <td style="font-weight: bold"><a style="color: black" href='<%#"DocumentsLibraryDetails.aspx?id="+Eval("FileId") %>'><%#Eval("FileTitle") %></a></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <table style="float: left">
                                                <tr>
                                                    <td>
                                                        <div>
                                                            <a target="_blank" href="https://twitter.com/share" class="twitter-share-button" data-url='<%#"http://shepherdmeeting.com/shepherdmeeting.com/DocumentsLibraryDetails.aspx?id="+Eval("FileId") %>'></a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="fb-share-button" data-href='<%#"http://shepherdmeeting.com/shepherdmeeting.com/DocumentsLibraryDetails.aspx?id="+Eval("FileId") %>' data-type="button_count"></div>
                                                    </td>
                            ...
                            <ItemTemplate>
                                <table style="margin: auto">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:HyperLink runat="server" ImageUrl="~/themes/Default/img/Sound.png" NavigateUrl='<%# "DocumentsLibraryDetails.aspx?id=" +Eval("FileId")  %>' ID="lnkVideo"></asp:HyperLink></td>
                                    </tr>
                                </table>
                            </ItemTemplate>
                        </asp:TemplateField>
