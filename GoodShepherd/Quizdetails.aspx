<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInside.master" AutoEventWireup="true" CodeBehind="Quizdetails.aspx.cs" Inherits="Quizdetails" %>
        ...
        <tr>
            <td style="padding-top: 20px; padding-bottom: 20px">
                <div style="margin: auto" class="a2a_kit a2a_kit_size_32 a2a_default_style">
                    ...
                    <asp:HyperLink runat="server" ID="lnkDownlaod" ToolTip="تحميل المسابقة">
<img src="themes/Default/img/download2.png" />
        ...
        <tr>
            <td style="text-align: center">
                <asp:Literal runat="server" ID="frmQuiz"></asp:Literal>
            </td>
        </tr>
    </table>
</asp:Content>
