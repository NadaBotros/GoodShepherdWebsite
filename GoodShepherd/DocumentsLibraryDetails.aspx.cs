...
public partial class DocumentsLibraryDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["id"] != null && !IsPostBack)
            {
                ...
                if (libaryFile != null)
                {
                    ...
                    lblFaceBookComment.Text = " <div id='fb-root'></div><script src='http://connect.facebook.net/en_US/all.js#xfbml=1'></script><fb:comments href='http://shepherdmeeting.com/shepherdmeeting.com/DocumentsLibraryDetails.aspx?id=" + libaryFile.FileId + "' num_posts='50' width='670px'></fb:comments>";
                }
            }
        }
