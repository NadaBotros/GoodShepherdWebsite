<%@ Page Title="" Language="C#" MasterPageFile="~/System/Backend/admin.Master" AutoEventWireup="true"
    CodeBehind="QuizList.aspx.cs" EnableEventValidation="false" Inherits="System.Backend.QuizList" %>
    ...
    <table width="100%" cellpadding="2" cellspacing="2">
        <tr>
            <td class="tdHeader">
                ...
                <asp:Label runat="server" Text="قائمة مسابقة الاجتماع" CssClass="tdPageTitle" ID="lblPageSubTitle"></asp:Label>
                <asp:HyperLink runat="server" class="addnew" ID="btnAddNew" NavigateUrl="~/System/Backend/Quiz/QuizManagement.aspx"
        ...
        <tr>
            <td>
                <asp:GridView ID="grdData" Width="100%" runat="server" CssClass="grd" DataSourceID="odsData"
                    ...
                    <Columns>
                         <asp:BoundField DataField="QuizTitle" HeaderText="اسم المسابقة" SortExpression="QuizTitle">
                            <HeaderStyle Width="60%" />
                            <ItemStyle Width="60%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="QuizDate" HeaderText="تاريخ المسابقة" SortExpression="QuizDate">
                            <HeaderStyle Width="15%" />
                            <ItemStyle Width="15%" />
                        </asp:BoundField>
                        
                        <asp:TemplateField HeaderText="تحميل المسابقة">
                            <ItemTemplate>
                                <asp:HyperLink Target="_blank" NavigateUrl='<%# "~/files/quiz/"+Eval("QuizPDF") %>' runat="server" ID="lnkDownload">تحميل</asp:HyperLink>
                            </ItemTemplate>
                            <HeaderStyle Width="15%" />
                            <ItemStyle Width="15%" />
                        </asp:TemplateField>                        
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="imgEdit" runat="server" CssClass="imgIcon3 tip_right_top" NavigateUrl='<%#"QuizManagement.aspx?id="+Eval("QuizId")%>'
                                ...
                                <asp:ImageButton ID="imgRestore" runat="server" CssClass="imgIcon3 tip_right_top"
                                    ...
                                    CommandArgument='<%# Eval("QuizId") %>' Visible='<%# DAL.GeneralMethods.DeleteRestorVisible(Eval("Active"),"true") %>'
                                ...
                                <asp:ImageButton ID="imgDelete" runat="server" CssClass="imgIcon3 tip_right_top" ImageUrl="../lib/img/Delete.png"
                                    CommandName="deleteitem" CommandArgument='<%# Eval("QuizId") %>' OnClientClick="if(!confirm('Are you sure you want delete this?')) return false;"
