...
{
    public partial class FilterPeopleHaveServantsRV : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Session["lstFields"] != null && Session["lstIds"] != null)
                {
                    ...
                    grdData.DataSource = obj.FilterPeopleHaveServants(Ids, cols, Request.QueryString["orderby"].ToString());
                    grdData.DataBind();
