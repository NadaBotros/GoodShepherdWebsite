<%@ Page Title="" Language="C#" MasterPageFile="~/System/Backend/admin.Master" AutoEventWireup="true"
    CodeBehind="ActivityList.aspx.cs" EnableEventValidation="false" Inherits="System.Backend.ActivityList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHPageHeader" runat="server">
    <img src="../lib/icons/32/Dashboard.png" class="imgIcon" /><asp:Label runat="server"
        Text="الرحلات و المؤتمرات" CssClass="tdMainTitle" ID="lblPageMainTitle"></asp:Label>
</asp:Content>
    ...
    <table width="100%" cellpadding="2" cellspacing="2">
        <tr>
            <td class="tdHeader">
                ...
                <asp:Label runat="server" Text="قائمة الرحلات و المؤتمرات" CssClass="tdPageTitle" ID="lblPageSubTitle"></asp:Label>
                <asp:HyperLink runat="server" class="addnew" ID="btnAddNew" NavigateUrl="~/System/Backend/Activity/ActivityManagement.aspx"
        ...
        <tr>
            <td>
                <asp:GridView ID="grdData" Width="100%" runat="server" CssClass="grd" DataSourceID="odsData"
                    ...
                    <Columns>
                         <asp:BoundField DataField="ActivityTitle" HeaderText="اسم النشاط" SortExpression="ActivityTitle">
                            <HeaderStyle Width="60%" />
                            <ItemStyle Width="60%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ActivityPlace" HeaderText="مكان النشاط" SortExpression="ActivityPlace">
                            <HeaderStyle Width="15%" />
                            <ItemStyle Width="15%" />
                        </asp:BoundField>
                        
                        <asp:TemplateField HeaderText="تاريخ النشاط">
                            <ItemTemplate>
                               <%# DateTime.Parse(Eval("ActivityDate").ToString()).ToString("d/M/yyyy") %>
                            </ItemTemplate>
                            <HeaderStyle Width="15%" />
                            <ItemStyle Width="15%" />
                        </asp:TemplateField>                        
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="imgEdit" runat="server" CssClass="imgIcon3 tip_right_top" NavigateUrl='<%#"ActivityManagement.aspx?id="+Eval("ActivityId")%>'
                                ...
                                <asp:ImageButton ID="imgRestore" runat="server" CssClass="imgIcon3 tip_right_top"
                                    ...
                                    CommandArgument='<%# Eval("ActivityId") %>' Visible='<%# DAL.GeneralMethods.DeleteRestorVisible(Eval("Active"),"true") %>'
                                ...
                                <asp:ImageButton ID="imgDelete" runat="server" CssClass="imgIcon3 tip_right_top" ImageUrl="../lib/img/Delete.png"
                                    CommandName="deleteitem" CommandArgument='<%# Eval("ActivityId") %>' OnClientClick="if(!confirm('Are you sure you want delete this?')) return false;"
