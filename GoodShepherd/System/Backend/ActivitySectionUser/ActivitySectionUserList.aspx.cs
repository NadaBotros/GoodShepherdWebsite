...
{
    public partial class ActivitySectionUserList : MangeBackend
    {
        #region Variables
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DAL.ActivitySectionUserManagement obj = new ActivitySectionUserManagement();
        ...
        protected void drpActivitySection_SelectedIndexChanged(object sender, EventArgs e)
        {
            grdData.DataBind();
        }
    }
