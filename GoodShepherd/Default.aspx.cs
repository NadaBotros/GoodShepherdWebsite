    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        public void GetInfo()
        {
            try
            {
                ...
                if (_ViewDailyMeetingWithGod != null)
                {
                    lblArticleAya.Text = _ViewDailyMeetingWithGod.Aya;
                    lblArticleText.Text = _ViewDailyMeetingWithGod.ArticleContent.Replace("..", "").Replace(".", ".<br>");
                    lblArticleTitle.Text = _ViewDailyMeetingWithGod.Title;
                    lblArticleWriter.Text = _ViewDailyMeetingWithGod.ArticleBy;
                }
                ViewMagazineStory _ViewMagazineStory = obj.MagazineStories();
                if (_ViewMagazineStory != null)
                {
                    lblStoryText.Text = _ViewMagazineStory.StoryContent.Replace("\n", "<br>");
                    lblStoryTitle.Text = _ViewMagazineStory.StoryTitle;
                }
