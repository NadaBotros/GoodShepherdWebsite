...
public partial class SoundLibrary : System.Web.UI.Page
{
    ...
    public void GetInfo(string PageTitle, string LId)
    {
        ...
        grdFiles.DataBind();
        if (grdCategories.Rows.Count > 0 || grdFiles.Rows.Count > 0)
            lblMsg.Text = "";
        else
        ...
        if (Request.QueryString["id"] != null && !string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            Library ent = obj.LoadById(Request.QueryString["id"]);
            if (ent != null)
            {
